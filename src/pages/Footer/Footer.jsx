                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li><NavLink to="/about" className={({ isActive }) => isActive ? 'font-bold text-green-400' : 'font-bold text-white'}>About Us</NavLink></li>
                            <li><NavLink to="/contact" className={({ isActive }) => isActive ? 'font-bold text-green-400' : 'font-bold text-white'}>Contact Us</NavLink></li>
                        </ul>
                    </div>
