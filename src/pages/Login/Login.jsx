        ...
        <div className="mt-3 lg:flex gap-0">
            ...
            <div className="container mx-auto  w-full max-w-md p-8 space-y-3 rounded-xl bg-slate-200 ">
                ...
                <form
                    ...
                    <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 bg-blue-400">Log In</button>
                </form>
            ...
            <div >
                <img className='lg:w-[400px] lg:h-[300px] mt-5 lg:mt-32 rounded-lg container lg:mr-40' src={picture} alt="" />
            </div>
        </div>
    );
};
