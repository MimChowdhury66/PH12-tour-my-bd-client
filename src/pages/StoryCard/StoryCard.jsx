                ...
                <div className="flex flex-col max-w-sm mx-4  shadow-lg ">
                    <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
                        <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-8 h-8 dark:text-default-600">
                                <path d="M232,246.857V16H16V416H54.4ZM48,48H200V233.143L48,377.905Z"></path>
                                <path d="M280,416h38.4L496,246.857V16H280ZM312,48H464V233.143L312,377.905Z"></path>
                            </svg>{reviewText}
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="absolute right-0 w-8 h-8 dark:text-default-600">
                    ...
                    <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-default-600 dark:text-gray-50">
                        ...
                        <p className="text-xl font-semibold leading-tight">{reviewerName}</p>
